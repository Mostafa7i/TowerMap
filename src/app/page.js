      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div>
            ...
            <h1 dir="ltr" className="font-black text-2xl md:text-7xl text-white mb-6 leading-tight">
              <TextEffect/>
            </h1>
            ...
            <p className="text-gray-300 text-lg md:text-2xl max-w-4xl mx-auto leading-relaxed mb-12 font-light">
              ...
              باستخدام تقنية <bdi className="font-bold text-violet-400">SNMP</bdi> والذكاء الاصطناعي
            </p>

            <div className="flex flex-wrap justify-center gap-6">
              <button className="group relative px-10 py-5 bg-linear-to-r from-violet-600 to-fuchsia-600 text-white rounded-2xl font-bold text-lg overflow-hidden
               transition-all duration-300 hover:shadow-[0_0_40px_rgba(139,92,246,0.6)] hover:scale-105">
              ...
              <button className="px-10 py-5 bg-white/10 backdrop-blur-md border-2 border-white/20 text-white rounded-2xl font-bold text-lg transition-all duration-300
      ...
      <div className="relative bg-linear-to-b from-slate-950 to-slate-900 py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group relative bg-linear-to-br from-emerald-500/10 to-emerald-600/5 backdrop-blur-sm border border-emerald-500/20 
            p-8 rounded-3xl transition-all duration-500 hover:scale-105 hover:border-emerald-400/40 hover:shadow-[0_0_50px_rgba(16,185,129,0.3)]">
              <div className="absolute -top-6 -right-5 w-20 h-20 bg-linear-to-br from-emerald-400 to-emerald-600 rounded-3xl flex items-center 
              ...
              <div className="mt-12">
                <h3 className="text-3xl font-black text-white mb-4">أمان عالي</h3>
                <p className="text-gray-300 text-lg leading-relaxed">
                  حماية متعددة الطبقات باستخدام تقنية <span className="text-emerald-400 font-bold">JWT</span> وتشفير من الدرجة العسكرية لضمان سلامة بياناتك
                </p>
              </div>
            ...
            {/* Feature 2 */}
            <div className="group relative bg-linear-to-br from-rose-500/10 to-rose-600/5 backdrop-blur-sm border border-rose-500/20 p-8 
            rounded-3xl transition-all duration-500 hover:scale-105 hover:border-rose-400/40 hover:shadow-[0_0_50px_rgba(244,63,94,0.3)]">
              <div className="absolute -top-6 -right-5 w-20 h-20 bg-linear-to-br from-rose-400 to-rose-600 rounded-3xl flex items-center 
              ...
              <div className="mt-12">
                <h3 className="text-3xl font-black text-white mb-4">تنبيهات فورية</h3>
                <p className="text-gray-300 text-lg leading-relaxed">
                  اكتشاف تلقائي للمشاكل وإشعارات في الوقت الفعلي عبر البريد الإلكتروني والرسائل النصية
                </p>
              </div>
            ...
            {/* Feature 3 */}
            <div className="group relative bg-linear-to-br from-sky-500/10 to-sky-600/5 backdrop-blur-sm border border-sky-500/20 p-8
             rounded-3xl transition-all duration-500 hover:scale-105 hover:border-sky-400/40 hover:shadow-[0_0_50px_rgba(14,165,233,0.3)]">
              <div className="absolute -top-6 -right-5 w-20 h-20 bg-linear-to-br from-sky-400 to-sky-600 rounded-3xl flex items-center 
              ...
              <div className="mt-12">
                <h3 className="text-3xl font-black text-white mb-4">أداء سريع</h3>
                <p className="text-gray-300 text-lg leading-relaxed">
                  معالجة فائقة السرعة للبيانات وتحليل فوري باستخدام خوارزميات الذكاء الاصطناعي المتقدمة
                </p>
              </div>
      ...
      <div className="relative bg-slate-900 py-10 px-4">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-8 ">
            <div className="group text-center   p-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl hover:bg-white/10 
            transition-all duration-300 hover:scale-105">
              <div className="text-4xl md:text-6xl font-black bg-linear-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent
            ...
            <div className="group text-center p-8 bg-white/5 place-content-center backdrop-blur-sm border border-white/10 rounded-2xl hover:bg-white/10
             transition-all duration-300 hover:scale-105">
              <div className="text-3xl  md:text-6xl font-black bg-linear-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent
               mb-3 group-hover:scale-110 transition-transform">
                24/7
              </div>
            ...
            <div className="group text-center p-8 place-content-center bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl
             hover:bg-white/10 transition-all duration-300 hover:scale-105">
              <div className="text-3xl md:text-6xl font-black bg-linear-to-r from-rose-400 to-pink-400 bg-clip-text 
            ...
            <div className="group text-center p-8 place-content-center bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-400 text-lg font-medium">برج تحت المراقبة</p>
            </div>
          </div>
        </div>
      </div>
